...
export const searchFilter = (searchText) => (
    {type: SEARCH_FILTER, payload: searchText}
)

export const voteFilter = (value) => (
    {type: VOTE_FILTER, payload: value}
)

export const statusFilter = (value) => (
    {type: STATUS_FILTER, payload: value}
)

export const categoryFilter = (value) => (
    {type: CATEGORY_FILTER, payload: value}
)