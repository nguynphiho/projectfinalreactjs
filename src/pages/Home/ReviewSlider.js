      ...
      <Swiper   
        ...
        <SwiperSlide className={classes.hero}>
            <Grid>
                ...
                <Typography style={{margin: '24px 0 0',}} className={classes.body}>"Impedit sententiae mea cu, at cum dicat molestiae philosophia. Et quo illum vituperatoribus.</Typography>
                <Typography className={classes.body}>Insolens persequeris ut usu. Qui no nostro audire vocibus."</Typography>
