  ...
  return (
    <>
      ...
      >
        <SwiperSlide>
            <Box>
                <Box className={classes.img} component="img" src="https://verdure.qodeinteractive.com/wp-content/uploads/2018/04/home-4-rev-img-1.jpg">
                </Box>
        ...
        <SwiperSlide>
            <Box>
                <Box className={classes.img} component="img" src="https://verdure.qodeinteractive.com/wp-content/uploads/2018/04/home-4-rev-img-4.jpg">
                </Box>
                <Box className={classes.whitebox}>
                    <Box className={classes.headertext}>
        ...
        <SwiperSlide>
            <Box>
                <Box className={classes.img} component="img" src="https://verdure.qodeinteractive.com/wp-content/uploads/2018/04/home-4-rev-img-3.jpg">
                </Box>
                <Box className={classes.whitebox}>
                    <Box className={classes.headertext}>
