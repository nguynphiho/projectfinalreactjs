...
export default function Checkout() {
  ...
  const [messErrCheckOut, setMessErrCheckOut] = useState('');
  const { value: errorCheckOut, setValue: setErrorCheckOut } = useCheckbox(false);
  // submit checkout
        ...
        <Grid
            ...
            <Grid container xs={10} item className={classes.paper}>
                <Grid style={{ flexGrow: 1, padding: 10 }} xs container item>
                    <span style={{ fontWeight: 300}}>Checkout is not available whilst your cart is empty.</span>
                </Grid>
            </Grid>
            <Grid container xs={10} item className={classes.paper}>
                <Grid style={{ flexGrow: 1, padding: 10 }} xs container item justifyContent="center">
                    <Typography variant='h5'>Your cart is currently empty.</Typography>
                </Grid>
            </Grid>
            <Grid style={{ flexGrow: 1 }} xs container item justifyContent="center">
                    <PlaceOrder onClick={() => navigate("/products")}>RETURN TO SHOP</PlaceOrder>
            </Grid>
        </Grid>
    :
    <>
        ...
        <Grid
                ...
                >
                            ...
                            <Grid xs={12} md={6} xl={6} item>
                                ...
                                <Grid container item spacing={1} className={classes.top}>
                                    <Grid xs={12} md={6} xl={6} item>
                                        ...
                                        <TextField className={classes.input} variant="outlined" value={fname} onChange={onChangefName} />
                                    </Grid>
                                    <Grid xs={12} md={6} xl={6} item>
                                        <Typography>Last name *</Typography>
                                        <TextField className={classes.input} variant="outlined" value={lname} onChange={onChangelName} />
                                    </Grid>
                                </Grid>
                                ...
                                <Grid container item className={classes.top}>
                                    ...
                                    <TextField className={classes.input} variant="outlined" value={street} onChange={onChangeStreet} />
                                </Grid>
                                <Grid container item className={classes.top}>
                                ...
                                <Grid container item className={classes.top}>
                                    ...
                                    <TextField className={classes.input} variant="outlined" value={town_city} onChange={onChangeCity}/>
                                </Grid>
                                <Grid container item className={classes.top}>
                                    <Typography>Phone *</Typography>
                                    <TextField className={classes.input} variant="outlined" value={phone} onChange={onChangePhone} />
                                </Grid>
                                <Grid container item className={classes.top}>
                                    <Typography>Email address *</Typography>
                                    <TextField className={classes.input} variant="outlined" value={email} onChange={onChangeEmail} />
                                </Grid>
                            </Grid>
                            <Grid xs={12} md={6} xl={6} item>
                        ...
                        <Grid container xs={10} item spacing={3} style={{ marginTop: 20 }}>
                            ...
                            {cartStore.map((product) => <Grid xs={12} item key={product.id}>
                                <Grid container item spacing={3} className={classes.menu}>
                                    <Grid xs={8} item>
                                        <span style={{ fontSize: 18 }}>{product.name}</span>
                                        <span style={{ fontWeight: 700, marginLeft: 10, fontSize: 18 }}>x {product.quantity}</span>
                                    </Grid>
                                    <Grid xs={4} item>
                                        <span style={{ fontSize: 18 }}>€{Math.round(product.quantity * product.price)}</span>
                                    </Grid>
                                </Grid>
                            </Grid>
                            )}
                            <Grid xs={12} item>
                                <Grid container item spacing={3} className={classes.menu}>
                                    ...
                                    <Grid xs={4} item>
                                        <span style={{ fontSize: 18 }}>€{Math.round(subTotal)}</span>
                                    </Grid>
                                </Grid>
                            </Grid>
                            <Grid xs={12} item>
                                <Grid container item spacing={3} className={classes.menu}>
                                    ...
                                    <Grid xs={4} item>
                                        <span style={{ fontSize: 18, fontWeight: 700 }}>€{Math.round(subTotal)}</span>
                                    </Grid>
                                </Grid>
                            </Grid>
                            <PlaceOrder style={{ marginTop: 30 }} onClick={handleSubmitPlaceOrder}>Place Order</PlaceOrder>
                        </Grid>
        </Grid>
    </>
    }
