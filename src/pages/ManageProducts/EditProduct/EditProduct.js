import { Button, FormControl, Grid, makeStyles, MenuItem, Select, TextField, Typography } from '@material-ui/core';
...
function EditProduct() {
  ...
  const productStore = useSelector((state) => state.productReducer.productSelected)
  ...
  return (
    <div className={classes.container}>
      ...
      <Grid container alignItems="center" justifyContent="space-between">
        <Grid item className={classes.title}>Edit Product</Grid>
        <Grid item>
          <Button
            variant="contained"
            color="secondary"
