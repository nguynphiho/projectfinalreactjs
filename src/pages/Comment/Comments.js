...
const data = [
    {
      ...
      },
      {
        ...
        parentId: null,
        createdAt: "2021-08-16T23:00:33.010+02:00",
        avatar: 'https://verdure.qodeinteractive.com/wp-content/uploads/2018/04/blog-user-img-1.png'
      },
      {
        id: "3",
...
function Comments({currentUserId}) {
    ...
    const getReplies = commendId => {
        return backendComments.filter(backendComments => backendComments.parentId === commendId)
    }
    ...
    setBackendComments([createComment(text,parentId ,username), ...backendComments])
}
